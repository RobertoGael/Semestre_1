...
namespace U5P9 // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("Ingresa el sueldo diario del trabajador:");
            double sueldo_Diario = Convert.ToDouble(Console.ReadLine());

            Console.WriteLine("Ingresa el tiempo laborado en meses:");
